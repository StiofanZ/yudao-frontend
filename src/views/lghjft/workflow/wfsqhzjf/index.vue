<template>
  <div class="apply-form-container">
    <el-card shadow="never">
      ...
      <el-form ref="formRef" :model="formData" :rules="rules" label-width="180px" label-position="left" size="default">
        <!-- 1. 基本信息区域 -->
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="申请汇总缴费单位社会信用代码" prop="xyxdm">
              <el-input v-model="formData.xyxdm" maxlength="18" show-word-limit placeholder="请输入18位社会信用代码" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="申请汇总缴费单位全称" prop="dwqc">
              <el-input v-model="formData.dwqc" maxlength="255" placeholder="请输入单位全称（与公章一致）" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="主管税务部门" prop="zgsbm">
              <el-input v-model="formData.zgsbm" maxlength="255" placeholder="请输入所属主管税务机关全称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="缴费单位地址" prop="dwdz">
              <el-input v-model="formData.dwdz" maxlength="500" placeholder="请输入单位注册地址或实际经营地址" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="工会法人登记证件号码" prop="ghfrdjzjh">
              <el-input v-model="formData.ghfrdjzjh" maxlength="30" placeholder="请输入工会法人资格登记证号码" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="缴费单位工会全称" prop="ghqc">
              <el-input v-model="formData.ghqc" maxlength="255" placeholder="请输入工会全称（与工会公章一致）" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="职工总人数" prop="zzgzs">
              <el-input v-model.number="formData.zzgzs" type="number" min="0" placeholder="请输入单位在册职工总人数" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="工会会员数" prop="ghyhs">
              <el-input v-model.number="formData.ghyhs" type="number" min="0" placeholder="请输入工会会员人数" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="工会负责人" prop="ghfzr">
              <el-input v-model="formData.ghfzr" maxlength="50" placeholder="请输入工会主席/负责人姓名" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="联系电话" prop="lxdh">
              <el-input v-model="formData.lxdh" maxlength="20" placeholder="请输入联系电话（手机/座机）" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="工会账户账号" prop="ghzhzh">
              <el-input v-model="formData.ghzhzh" maxlength="50" placeholder="请输入工会专用银行账户账号" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="开户银行名称" prop="khyhmc">
              <el-input v-model="formData.khyhmc" maxlength="100" placeholder="请输入开户银行全称（如：中国工商银行XX支行）" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="工会账户户名" prop="ghzhhm">
              <el-input v-model="formData.ghzhhm" maxlength="255" placeholder="请输入工会账户开户名称（与工会全称一致）" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="开户银行网点代码" prop="khyhwdm">
              <el-input v-model="formData.khyhwdm" maxlength="20" placeholder="选填：请输入开户银行网点联行号/代码" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-form-item label="汇总申报缴纳原因" prop="hzbsjygy">
          <el-input v-model="formData.hzbsjygy" type="textarea" :rows="4"
            placeholder="请详细说明汇总申报缴纳原因（如：下属分支机构较多、统一管理等）" />
        </el-form-item>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="经办人姓名" prop="jbrxm">
              <el-input v-model="formData.jbrxm" maxlength="50" placeholder="请输入经办人姓名" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="经办人联系电话" prop="jbrdh">
              <el-input v-model="formData.jbrdh" maxlength="20" placeholder="请输入经办人联系电话（确保能正常联系）" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-form-item label="分支机构信息">
          <div class="branch-info">
            ...
            <el-button type="primary" size="small" icon="el-icon-edit" @click="openBranchDialog"
