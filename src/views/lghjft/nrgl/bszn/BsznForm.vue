      ...
      <el-row :gutter="24">
        ...
        <el-col :span="12">
          <el-form-item label="咨询电话" prop="zxdh">
            <el-input v-model="formData.zxdh" placeholder="请输入咨询电话" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="24">
        <el-col :span="12">
          <el-form-item label="法定时限" prop="fdsx">
            <el-input v-model="formData.fdsx" placeholder="请输入法定时限" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="承诺时限" prop="cnsx">
            <el-input v-model="formData.cnsx" placeholder="请输入承诺时限" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="24">
        <el-col :span="24">
          <el-form-item label="收费标准" prop="sfbz">
            <el-input v-model="formData.sfbz" placeholder="请输入收费标准" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="24">
...
const submitForm = async () => {
  ...
  try {
    ...
    if (data.id) {
      await updateBszn(data)
      ElMessage.success('修改成功')
    } else {
      await createBszn(data)
