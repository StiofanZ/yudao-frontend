      ...
      <el-row :gutter="24">
        <el-col :span="12">
          <el-form-item label="问题分类" prop="wtfl">
            <el-input v-model="formData.wtfl" placeholder="请输入问题分类" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
...
const submitForm = async () => {
  ...
  try {
    ...
    if (data.id) {
      await updateCjwt(data)
      ElMessage.success('修改成功')
    } else {
      await createCjwt(data)
